...
$(document).ready(function(){
	...
	if(!minisize_sidebar){
		...
		if($('.wrapper').hasClass('sidebar_minisize')){
			mini_sidebar = 1;
		...
		minibutton.on('click', function() {
			if (mini_sidebar == 1) {
				$('.wrapper').removeClass('sidebar_minisize');
				minibutton.removeClass('toggled');
				minibutton.html('<i class="icon-menu"></i>');
				mini_sidebar = 0;
			} else {
				$('.wrapper').addClass('sidebar_minisize');
				minibutton.addClass('toggled');
				minibutton.html('<i class="icon-options-vertical"></i>');
				mini_sidebar = 1;
			}
	...
	$('.sidebar').hover(function() {
		if ($('.wrapper').hasClass('sidebar_minisize')){
			$('.wrapper').addClass('sidebar_minisize_hover');
		}
	}, function(){
		if ($('.wrapper').hasClass('sidebar_minisize')){
			$('.wrapper').removeClass('sidebar_minisize_hover');
		}
	});
